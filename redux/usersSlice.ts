...
export const getUsers = createAsyncThunk<object, IGetUsers, {dispatch: AppDispatch}>(
    'users/getUsers',
...
export const searchUsers = createAsyncThunk<object, ISearchUsers, {dispatch: AppDispatch}>(
    'users/searchUsers',
...
export const sortByMostChats = createAsyncThunk<object, IGetUsers, {dispatch: AppDispatch}>(
...
export const sortByMostSentMessages = createAsyncThunk<object, IGetUsers, {dispatch: AppDispatch}>(
...
export const sortByMostEnteredCharacters = createAsyncThunk<object, IGetUsers, {dispatch: AppDispatch}>(
...
export const addFriend = createAsyncThunk<object, IAddFriend, {dispatch: AppDispatch}>(
    'users/addFriend',
...
export const refuseOwnFriendRequest = createAsyncThunk<object, IRefuseFriendRequest, {dispatch: AppDispatch}>(
...
export const deleteFriend = createAsyncThunk<object, IRefuseFriendRequest, {dispatch: AppDispatch}>(
    'users/deleteFriend',
    async function ({id}, {dispatch}) {
             dispatch(setProfilePending(true))
...
export const confirmFriendRequest = createAsyncThunk<object, IAddFriend, {dispatch: AppDispatch}>(
...
export const rejectFriendRequest = createAsyncThunk<object, IRefuseFriendRequest, {dispatch: AppDispatch}>(
